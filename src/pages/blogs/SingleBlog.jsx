    ...
    <article className="mt-8">
      <div className="mb-4 md:mb-0 w-full mx-auto relative">
        <div className="px-4 lg:px-0">
          ...
          <a
            href="#"
            className="text-green-700  py-2 inline-flex items-center justify-center mb-2"
          >
            {category}
          </a>
        </div>
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-2">
        <div className="px-4 lg:px-0 mt-8 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4">
          ...
          <p>
            ...
            optio? Quam, dignissimos quidem? Culpa necessitatibus, hic a cumque,
            molestias dicta nisi autem consequatur beatae tenetur laudantium
            eveniet quas consequuntur, repudiandae incidunt
          </p>
        </div>
        ...
        <div className="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
          <div className="p-4 border-t border-b md:border md:rounded">
            ...
            <button className="bg-green-700 px-2 py-1 text-gray-100 w-full flex items-center justify-center rounded">
              Follow
              <AiOutlineHeart className="ml-2" />
            </button>
          </div>
